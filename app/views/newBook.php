            ...
            <div class="books-grid-text">
                ...
                <article class="text-card editBook-form-card">
                    <div class="edit-book-picture-container">
                        ...
                        <input type="file" id="book-file" name="picture" form="edit-book-form"
                            accept="image/png, image/jpeg" style="display: none;">
                    </div>
                    <form action="index.php?action=newBook" method="POST" enctype="multipart/form-data"
                        id="edit-book-form" class="book-form">

                        <div class="form-group">
                            <label for="title">Titre</label>
                            <input type="text" id="title" name="title"
                                value="<?php echo htmlspecialchars($formData['title'] ?? ''); ?>" placeholder="Titre"
                                novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <input type="test" id="author" name="author"
                                value="<?php echo htmlspecialchars($formData['author'] ?? ''); ?>" placeholder="Autheur"
                                novalidate>
